...
!!! info "This project and most Reloaded projects are governed by the [GPLv3](https://www.gnu.org/licenses/gpl-3.0.en.html) license."
...
link Reloaded Libraries into your project through various linking approaches.
...
- **Method-Level Disclosure:** For individual methods or small code snippets, we use appropriate
  attribution methods. For example, methods borrowed or adapted from MIT-licensed projects might be marked
  with language-specific attributes or annotations.
...
Methods or code snippets marked with attribution annotations may be consumed using their original license terms.
For example, if a method is marked as being from an MIT-licensed project, you may use that specific code
